        ...
        child: Column(
          children: [
            Container(
              ...
              child: Stack(
                children: [
                  Center(child: MyText('Subscription Plans',color: Colors.white,fontSize: 20.sp,))
                  ,Positioned(
                      left: 16.sp,
                      top: 0,
                      bottom: 0,
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: const Divider(        color: Color(0xFF3DAEF5),
                        ),
                      ),
                      MyText(
  ...
  getFeatures(String title){
    return                       Container(
      ...
      child: Row(
        ...
        children: [
          const Icon(Icons.star,color: Color(0xffF7D55C),),
          SizedBox(width: 8.sp,),
