...
import '../bottom_bar_parent/profile_screens/manage_children_screen.dart';
import '../teacher_data/show_children.dart';
import '../teacher_data/show_class.dart';
import '../utils/colors.dart';
import '../utils/custom_widget/container_decoration.dart';
import '../utils/custom_widget/menu_custom_tab.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        LoginApiShadePreference.preferences!.get('role') ==
                                'parents'
                            ? MenuCustomTab.customTab(context, 'My Children',
                                () {}, 'images/users.png')
                            : SizedBox(),
                        SizedBox(
                          height: 10.h,
                        ),
                        MenuCustomTab.customTab(context, 'My Kids', () {
                        ...
                        MenuCustomTab.customTab(context, 'My Classes ', () {
                          Navigator.push(context, MaterialPageRoute(
                            builder: (context) {
                              return TeacherClass();
                            },
                        ...
                        MenuCustomTab.customTab(context, 'My Minutes ', () {},
                            'images/subscription.png'),
                        const SizedBox(
                          height: 10,
                        ),
                        MenuCustomTab.customTab(context, 'My Subscription',
                            () {}, 'images/subscription.png'),
                        const SizedBox(
                          height: 10,
                        ),
                        MenuCustomTab.customTab(context, 'Preferences', () {},
                            'images/preferences.png'),
                        const SizedBox(
                          height: 10,
                        ),
                        MenuCustomTab.customTab(
                            context, 'Security', () {}, 'images/security.png'),
                        const SizedBox(
                          height: 10,
                        ),
                        Container(
