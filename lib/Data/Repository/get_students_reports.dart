...
class GetStudentsReports {
  Future getStudentsReports(String studentId) async {
    ...
    try {
      ...
      var url = Uri.parse(
          'https://www.dev.schoolsnow.parentteachermobile.com/api/parent/student/report?student_id=$studentId&quarter_id=');
