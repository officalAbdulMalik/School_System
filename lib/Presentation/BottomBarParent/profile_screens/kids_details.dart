              ...
              children: [
                ...
                Container(
                  ...
                  child: ListTile(
                    ...
                    // ),
                    title: Text(
                      "${widget.data[widget.index].firstName}${widget.data[widget.index].lastName}",
                          ...
                          child: Column(
                            children: [
                              ...
                              Expanded(
                                child: Center(
                                  child: MyText(
                                    "${widget.data[widget.index].mobile}",
                    ...
                    Navigator.pushReplacement(context, MaterialPageRoute(
                      builder: (context) {
                        return ReportDetailParent(
                          stdId: widget.data[widget.index].id.toString(),
                          className: '',
                          studentName:
                              "${widget.data[widget.index].firstName} ${widget.data[widget.index].lastName}",
                        );
